...
Galerías slider-h (16:9) y slider-v (2:3) con scroll-snap y flechas.
Soporte táctil (drag/swipe) y navegación por teclado.
Diseño responsive (desktop y mobile).
Accesibilidad: roles ARIA, focus y labels.
Carga de imágenes con loading="lazy".

Tecnologías

HTML5, CSS3, JavaScript vanilla
Font Awesome (iconos), Google Fonts (Poppins)
Deploy en Netlify
Tecnologías
